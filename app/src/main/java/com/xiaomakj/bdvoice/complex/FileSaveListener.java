...
import com.xiaomakj.bdvoice.play.UiMessageListener;
...
public class FileSaveListener extends UiMessageListener {
    ...
    public FileSaveListener(Handler mainHandler, String destDir, SaveListener saveListener) {
        super(mainHandler);
    ...
    private void close() {
        ...
        sendMessage("关闭文件成功");
        saveListener.success(getTtsFile());
    }
}

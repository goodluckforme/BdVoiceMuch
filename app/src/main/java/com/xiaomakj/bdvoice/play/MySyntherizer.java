...
public class MySyntherizer implements MainHandlerConstant {
    ...
    public int batchSpeak(ArrayList<kotlin.Pair<String, String>> texts) {
        List<SpeechSynthesizeBag> bags = new ArrayList<SpeechSynthesizeBag>();
        for (kotlin.Pair<String, String> pair : texts) {
            SpeechSynthesizeBag speechSynthesizeBag = new SpeechSynthesizeBag();
            speechSynthesizeBag.setText(pair.getFirst());
            if (pair.getSecond() != null) {
                speechSynthesizeBag.setUtteranceId(pair.getSecond());
            }
